...
<html lang="ru">
    ...
    <body>
        ...
        <main class="shop-page main-containter container">
            <div class="column">
                <div class="main-column">
                    <section class="shop-item">
                        <img src="img/store/store_chehol.jpg">
                        <span class="value">10 000 $</span>
                        <h2 class="item-title">Чехол</h2>
                        <button type="button" class="find-button">Купить</input>
                    </section>

                    <section class="shop-item">
                        <img src="img/store/store_tolstoy.jpg">
                        <span class="value">25 000 $</span>
                        <h2 class="item-title">Толстовка</h2>
                        <button type="button" class="find-button">Купить</input>
                    </section>

                    <section class="shop-item">
                        <img src="img/store/store_shava.jpg">
                        <span class="value">6 000 $</span>
                        <h2 class="item-title">Шаурма</h2>
                        <button type="button" class="find-button">Купить</input>
                    </section>

                    <section class="shop-item">
                        <img src="img/store/store_znachek.jpeg">
                        <span class="value">3 000 $</span>
                        <h2 class="item-title">Значок</h2>
                        <button type="button" class="find-button">Купить</input>
                    </section>

                    <section class="shop-item">
                        <img src="img/store/store_tshirt.jpg">
                        <span class="value">12 000 $</span>
                        <h2 class="item-title">Футболка</h2>
                        <button type="button" class="find-button">Купить</input>
                    </section>

                    <section class="shop-item">
                        <img src="img/store/store_zachetka.jpg">
                        <span class="value">∞ $</span>
                        <h2 class="item-title">Зачет</h2>
                        <button type="button" class="find-button">Купить</input>
                    </section>
                </div>
