        ...
        <div class="container">
            <nav class="main-navigation">
                ...
                <ul class="navigation-list">
                    <li class="navigation-item"><a href="index.php">Популярные вопросы</a></li>
                ...
                <ul class="user-list">
                    <li class="user-list-item"><a href="#">Вход</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <main class="main-containter container">
        <div class="column">
            <div class="main-column">
                <?php include ("getpostbyid.php"); 
                if ($error == 1) {
                  exit ("Похоже, такой страницы не существует!");  
                }; ?>
                
                <form class="comment-temp-form" method="POST" action= <?php echo 'AddComment.php?id=' . $_GET["id"]; ?> >
					<input type="text" name="textcomm" placeholder="Комментарий">
					<button class="find-button" type="submit">Отправить</button>
				</form>
            </div>
    ...
    <section class="modal modal-login">
        ...
        <form name="user-logging" action="testreg.php" method="post">
            <p>
                ...
                <input class="modal-icon-login" id="modal-login-input" name="login" type="text" placeholder="Логин" size="15" maxlength="15">
            </p>
            <p>
                <label class="visually-hidden" for="modal-login-password">Пароль</label>
                <input class="modal-icon-password" id="modal-login-password" name="password" type="password" placeholder="Пароль" size="15" maxlength="15">
            </p>
