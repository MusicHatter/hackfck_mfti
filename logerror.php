...
<html lang="ru">
    ...
    <body>
                        ...
                        <li class="navigation-item navigation-category-item">
                            ...
                            <div class="modal-category">
                                <ul class="category-list">
                                    <li><a href="cat.php?cat=111">Жилищно-коммунальный отдел</a></li>
                                    <li><a href="cat.php?cat=112">Отдел по работе с иностранными студентами</a></li>
                                    <li><a href="cat.php?cat=113">Отдел по обеспечению безопасности</a></li>
                                    <li><a href="cat.php?cat=114">ИТ отдел</a></li>
                                    <li><a href="cat.php?cat=115">Отдел по созданию и сохранению природных ресурсов</a></li>
                                    <li><a href="cat.php?cat=116">Отдел по обеспечению здравоохванения</a></li>
                                    <li><a href="cat.php?cat=117">Ректорат</a></li>
                                    <li><a href="cat.php?cat=118">Разное</a></li>
                                    <li><a href="cat.php?cat=119">Стипендиальный отдел</a></li>
                                    <li><a href="cat.php?cat=120">Не требует ответа</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
                        ...
                        <form class="find-form">
                            ...
                            <div class="find-filter">
                                ...
                                <select id="filter-category-form" name="filter-category">
                                    <option>Общага</option>
                                    <option>Универ</option>
                                    <option>Деньги</option>
                                    <option>Учеба</option>
                                    <option>Столовка</option>
                                </select>
                            </div>
        ...
        <div id="modal modal-login">
            <h2>Личный кабинет</h2>
            <p class="modal-description">Введите пожалуйста свой логин и пароль</p>
            <div class="login-error">Ошибка! Вы ввели неверный логин или пароль!</div>
        ...
        <section class="modal modal-question">
            ...
            <form class="temp-form" method="POST" action="#">
